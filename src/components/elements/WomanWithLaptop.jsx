...
const Header = () => {
  return (
    <section className="video-and-content">
      <div className="section-copy header">
        <h1 className="display-as-h0">
